...
form.addEventListener('submit', function (e) {
    ...
    if (isFormValid) {
        var nameRegi = $("#username").val();
        var mobRegi = $("#mobile").val();
        var emailRegi = $("#email").val();
        var passRegi = $("#password").val();
        var href = base_url+"admin/sign_up";
        $.ajax({
            type: "POST",
            url: href,
            ...
            success : function(data){
                if (data.status == 1){
                    ...
                    setTimeout(function(){window.location.href=base_url+"admin"},500);
                    } else {
